...
void escena4(int &width, int &height, Camera &c, std::vector<std::shared_ptr<Shape>> &scene) {
    ...
    scene.push_back(std::make_shared<Plane>(Vector3(0, 0, -1), 3, std::make_shared<LambertianDiffuse>(RGB(0.8f, 0.0f, 0.0f))));
    ...
    scene.push_back(std::make_shared<Plane>(Vector3(-1, 0, 0), 3, std::make_shared<LambertianDiffuse>(RGB(0.8f, 0.5f, 0.0f))));
    scene.push_back(std::make_shared<Plane>(Vector3(1, 0, 0), 3, std::make_shared<LambertianDiffuse>(RGB(0.0f, 0.0f, 0.8f))));
    scene.push_back(std::make_shared<Plane>(Vector3(0, 1, 0), 3, std::make_shared<LambertianDiffuse>(RGB(0.0f, 0.8f, 0.8f))));
    scene.push_back(std::make_shared<Plane>(Vector3(0, -1, 0), 3, std::make_shared<LambertianDiffuse>(RGB(1.0f, 0, 0))));
    ...
    scene.push_back(std::make_shared<Quadrilateral>(Point3(-2, 2.995, -2), Point3(2, 2.995, 3), std::make_shared<LightPower>(RGB(1000, 1000, 1000))));
    ...
    scene.push_back(std::make_shared<Sphere>(Point3(-1, -1.5, -1), 1, std::make_shared<PerfectSpecular>(0.5)));
    scene.push_back(std::make_shared<Sphere>(Point3(0, 1, 2), 1, std::make_shared<LambertianDiffuse>(RGB(0.8, 0.5, 0.1))));
    ...
    scene.push_back(std::make_shared<Sphere>(Point3(0.8, -2.5, -2), 0.5, std::make_shared<LambertianDiffuse>(RGB(0.5, 0, 0.5))));
...
void pruebaGeometria(int &width, int &height, Camera &c, std::vector<std::shared_ptr<Shape>> &scene) {
    // Camera l u f
    width = 1200;
    height = 1000;
    ...
    // scene.push_back(std::make_shared<Plane>(RGB(255, 0, 255), Vector3(0, -1, 0), 3, std::make_shared<LigthEmission>(LigthEmission(RGB(1.0f, 1.0f, 1.0f)))));
    // scene.push_back(std::make_shared<Sphere>(RGB(0, 80, 255), Point3(0.8, 1, -5), 1, std::make_shared<LigthEmission>(LigthEmission(RGB(1, 1, 1)))));
    scene.push_back(std::make_shared<Plane>(Vector3(0, -1, 0), 3, std::make_shared<LightPower>(RGB(10000, 10000, 10000))));
    // // // scene.push_back(std::make_shared<Quadrilateral>(RGB(255, 0, 255), Point3(-3, -2, 0), Point3(3, -2, 3), std::make_shared<LigthEmission>(LigthEmission(RGB(1.0f, 1.0f, 1.0f)))));
    ...
    scene.push_back(std::make_shared<Sphere>(Point3(-1, -1.5, 2), 1, std::make_shared<PerfectSpecular>(0.5f)));
    scene.push_back(std::make_shared<Sphere>(Point3(0, 1, -1), 1, std::make_shared<LambertianDiffuse>(RGB(0.8, 0.5, 0.1))));
    // scene.push_back(std::make_shared<Sphere>(RGB(255, 255, 0), Point3(-1.5, -1.5, 0), 1.5, std::make_shared<Phong>(Phong(RGB(0.7, 0.7, 0.1), RGB(0.2, 0.2, 0.1)))));
    // scene.push_back(std::make_shared<Sphere>(RGB(255, 255, 0), Point3(-1.5, -1.5, 0), 1.5, std::make_shared<LambertianDiffuse>(LambertianDiffuse(RGB(0.8, 0.5, 0.5)))));
    // scene.push_back(std::make_shared<Sphere>(RGB(255, 255, 0), Point3(0, -1.5, -1), 1.5, std::make_shared<PerfectSpecular>(PerfectSpecular(RGB(0.8, 0.5, 0.5)))));
    scene.push_back(std::make_shared<Sphere>(Point3(0.8, -2.5, -2), 0.5, std::make_shared<LambertianDiffuse>(RGB(0.5, 0, 0.5))));
...
void escenaPhong(int &width, int &height, Camera &c, std::vector<std::shared_ptr<Shape>> &scene) {
    // Camera l u f
    width = 480;
    height = 480;
    ...
    scene.push_back(std::make_shared<Sphere>(Point3(0, -1.5, 0), 1.5, std::make_shared<Phong>(Phong(RGB(0.5, 0.5, 0.5), 0.2, 50.0f))));
    scene.push_back(std::make_shared<Sphere>(Point3(0, -1.5, 0), 1.5, std::make_shared<PerfectSpecular>(PerfectSpecular(0.5f))));
...
void escenaDielectrico(int &width, int &height, Camera &c, std::vector<std::shared_ptr<Shape>> &scene) {
    // Camera l u f
    width = 400;
    height = 400;
    ...
    scene.push_back(std::make_shared<Plane>(Vector3(0, 0, -1), 3, std::make_shared<Texture>(Texture(TextureMappingUV(texture)))));
    // scene.push_back(std::make_shared<Plane>(RGB(255, 0, 0), Vector3(0, 0, 1), 5, std::make_shared<LambertianDiffuse>(LambertianDiffuse(RGB(0.8f, 0.5f, 0.0f)))));
    scene.push_back(std::make_shared<Plane>(Vector3(1, 0, 0), 3, std::make_shared<LambertianDiffuse>(RGB(0.7f, 0.45f, 0.65f))));
    scene.push_back(std::make_shared<Plane>(Vector3(-1, 0, 0), 3, std::make_shared<LambertianDiffuse>(RGB(0.44f, 0.86f, 0.86f))));
    scene.push_back(std::make_shared<Plane>(Vector3(0, 1, 0), 3, std::make_shared<LambertianDiffuse>(RGB(0.3f, 0.3f, 0.3f))));
    scene.push_back(std::make_shared<Plane>(Vector3(0, -1, 0), 3, std::make_shared<LambertianDiffuse>(RGB(0.3f, 0.3f, 0.3))));
    scene.push_back(std::make_shared<Plane>(Vector3(0, 0, 1), 20, std::make_shared<LambertianDiffuse>(RGB(0.2f, 0.2f, 0.2f))));

    scene.push_back(std::make_shared<Plane>(Vector3(0, -1, 0), 3, std::make_shared<LightPower>(RGB(10000, 10000, 10000))));
    // scene.push_back(std::make_shared<Quadrilateral>(RGB(255, 0, 255), Point3(-1, 2.995, -1), Point3(1, 2.995, 1), std::make_shared<LightEmission>(LightEmission(RGB(1000, 1000, 1000)))));
    scene.push_back(std::make_shared<Quadrilateral>(Point3(-2, 2.995, -5), Point3(2, 2.995, 5), std::make_shared<LightPower>(RGB(1.0f, 1.0f, 1.0f))));
    scene.push_back(std::make_shared<Quadrilateral>(Point3(2.8, 2.5, 1), Point3(2.8, -1, -7), std::make_shared<Texture>(TextureMappingUV(texture2))));
    ...
    scene.push_back(std::make_shared<Sphere>(Point3(0, -1.5, 0), 1.5, std::make_shared<Texture>(TextureMappingUV(texture))));
...
void escenaConejo(int &width, int &height, Camera &c, std::vector<std::shared_ptr<Shape>> &scene) {
    ...
    // scene.push_back(std::make_shared<Quadrilateral>(RGB(255, 0, 255), Point3(-1, 2.995, -1), Point3(1, 2.995, 1), std::make_shared<LightEmission>(LightEmission(RGB(1000, 1000, 1000)))));
    scene.push_back(std::make_shared<Quadrilateral>(Point3(-2, 2.995, -5), Point3(2, 2.995, 5), std::make_shared<LightPower>(RGB(1000, 1000, 1000))));
    ...
    scene.push_back(std::make_shared<Sphere>(Point3(0, 0, 0), 1, std::make_shared<LambertianDiffuse>(RGB(0.8, 0.5, 0.5))));
}
